...
TC - verify manual outbound calling is working
    ...
    Manual Dial Only    ${instance1}    ${CALLING_NUMBER}    ${CREDENTIALS['${RUN_AS}']['campaign_details']['voice']}
...
TC - verify create and dial feature is working
    ...
    Create and Dial Call    ${instance1}    ${random_calling_number}    ${random_customer_name}    ${CREDENTIALS['${RUN_AS}']['campaign_details']['voice']}
...
TC - verify manual preview dialing is working fine
    ...
    Manual Preview Dial    ${instance1}    ${saved_calling_number}    ${saved_customer_name}    ${CREDENTIALS['${RUN_AS}']['campaign_details']['voice']}
    End call and auto dispose    ${instance1}