...
...               https://touchstone.ameyo.com/linkto.php?tprojectPrefix=AP&item=testcase&id=AP-16036
...
*** Test Cases ***
TC - Verify live monitoring for supervisor user
    [Tags]  smoke    testid=AP-16036    regression
    I verify live monitoring    ${instance1}    supervisor
